...
Windows itself cannot be repaired, which means that you have to attach the hard disk to another PC to save your files.
Windows must then be reinstalled. Other hard drives are not affected by the tool

## Important
Starting from [v.2.8](https://github.com/MarcBeast/Windows-Destroyer/releases/tag/v.2.8) it tries to delete personal files, if this is not the goal use [v.2.7](https://github.com/MarcBeast/Windows-Destroyer/releases/tag/v.2.7)
